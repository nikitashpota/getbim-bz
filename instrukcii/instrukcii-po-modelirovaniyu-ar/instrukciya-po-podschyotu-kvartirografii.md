...
1.  **Заполнение параметра «ADSK\_Номер квартиры»**:
    ...
    * Рекомендуемый формат: 201, 202 203. Подробнее см. Правила нумерации квартир.
...
* **Автоматическая**: Заполняеться через плагин.
