...
1.  **Заполнение параметра «ADSK\_Номер квартиры»**:
    ...
    * Рекомендуемый формат: 201, 202 203. Подробнее см. [Правила нумерации квартир](../../reglament-bim/rabota-s-cifrovoi-informacionnoi-modelyu/trebovaniya-k-arkhitekturnoi-modeli/pravila-numeracii-kvartir.md).
...
* **Описание помещения:** Количество комнат и тип квартиры.
...
<div align="left"><figure><img src="../../.gitbook/assets/image (2) (1).png" alt="" width="142"><figcaption></figcaption></figure></div>
